...
<body style="background: #f3f3f3;">
	...
	<div class="goods_list">
		...
		<ul class="list_goods_ul">
			...
			<li>${goods.name }</li>
			<li>${goods.price }</li>
			<li><a href="${ctx }/GoodsServlet?action=editUI&id=${goods.id}"><img class="img_icon" src="${ctx }/admin/images/edit_icon.png" ></a></li>
			<li><a href="${ctx }/GoodsServlet?action=delGoods&id=${goods.id}"><img class="img_icon" src="${ctx }/admin/images/delete_icon.png"></a></li>
		</ul>
		</c:forEach>
